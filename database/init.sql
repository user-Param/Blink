...
GRANT USAGE ON SCHEMA public TO blink;
...
-- Ensure future tables created by param (superuser) are also accessible to blink
ALTER DEFAULT PRIVILEGES FOR ROLE param IN SCHEMA public
    GRANT ALL PRIVILEGES ON TABLES TO blink;

ALTER DEFAULT PRIVILEGES FOR ROLE param IN SCHEMA public
    GRANT ALL PRIVILEGES ON SEQUENCES TO blink;
